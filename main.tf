...
## AWS Virtual Private Cloud (VPC) definition
...
# Public subnets: internet gateway and routing tables
...
resource "aws_route_table_association" "public-a-association" {
    subnet_id = aw_subnet.public-subnet-a.id
    route_table_id = aws_route_table.public-route.id
}

resource "aws_route_table_association" "public-b-association" {
    subnet_id = aw_subnet.public-subnet-b.id
    route_table_id = aws_route_table.public-route.id
}

# Private subnets: EIP = elastic IP address; NAT = Network Address Translation
